							...
							<p className="text_white">
								...
								<p style={{fontWeight: 'bold'}} className="text_white text_italic">
									...
									<ol>
										...
										<li style={{fontStyle: 'normal', fontWeight: 'normal'}}>Witjes, M., Leal Parente, L., Krizan, J., Antonic, L., Hengl, T. (2023). Ecodatacube.eu: Analysis-ready open environmental data cube for Europe. PeerJ, <ALink href="https://doi.org/10.3390/rs12030426">https://doi.org/10.21203/rs.3.rs-2277090/v4</ALink></li>
									</ol>
								</p>
						</div>
					</div>
